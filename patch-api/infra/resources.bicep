metadata description = 'Resources for the patch-api sample: an App Service web front end (keyless, via managed identity) over a serverless, keyless Azure Cosmos DB account. Reuses the shared web-app and secure-cosmos modules. OrderStore holds the order documents the sample patches.'
